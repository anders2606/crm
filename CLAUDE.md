...
| M9 Serverpakke (DMG) | Bygget – prosessadministrasjon (DR-10/DR-11, nå med separate arm64- og x64-DMG-er etter at eier testet på en Intel-Mac), nøkkelring (DR-08), installasjonsveiviser og launchd-registrering i servermodus (DR-12/DR-13), instanslås (DR-07), eksport/import (DR-05), utvidet backup/gjenoppretting (DR-06), oppdateringsflyt (DR-14) og veiledning for usignert DMG/Mac mini-oppsett (DR-16/DR-17). DR-15 (ekstern tilgang, KAN) bevisst utsatt. Selve DMG-byggingen er verifisert i GitHub Actions på ekte macOS-runnere, men installasjon/kjøring på fysisk Mac-maskinvare er IKKE bekreftet ennå (se electron/README.md) |
