...
| M9 Serverpakke (DMG) | Pågår – prosessadministrasjon (DR-10/DR-11), nøkkelring (DR-08), installasjonsveiviser (DR-12/DR-13), instanslås (DR-07), eksport/import (DR-05) og utvidet backup/gjenoppretting (DR-06) bygget og verifisert headless, resten gjenstår. IKKE verifisert på ekte macOS (se electron/README.md) |
